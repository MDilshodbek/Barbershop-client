          ...
          >
            ...
            <List className={"sub-section"}>
              {user.memberType === "ADMIN" && (
                <>
                  <ListItem
                    className={pathname === "addService" ? "focus" : ""}
                  >
                    <Link
                      href={{
                        pathname: "/mypage",
                  ...
                  <ListItem
                    className={pathname === "ourServices" ? "focus" : ""}
                  >
                    <Link
                      href={{
                        pathname: "/mypage",
                        query: { category: "ourServices" },
                      }}
                      scroll={false}
                    >
                      <div className={"flex-box"}>
